...
class DetailsTest extends TestCase
{
    ...
    /** 
     * Test getDoNotDisturbStartTime()
     */
    public function testGetDoNotDisturbStartTime(): void
    {
        $this->assertEquals(
            self::$feeds[1]['do_not_disturb']['start_time'],
            self::$details[1]->getDoNotDisturbStartTime()
        );

        $this->assertNull(
            self::$details[0]->getDoNotDisturbStartTime()
        );
    }

    /** 
     * Test getDoNotDisturbEndTime()
     */
    public function testGetDoNotDisturbEndTime(): void
    {
        $this->assertEquals(
            self::$feeds[1]['do_not_disturb']['end_time'],
            self::$details[1]->getDoNotDisturbEndTime()
        );

        $this->assertNull(
            self::$details[0]->getDoNotDisturbEndTime()
        );
    }
